...
public final class BatchableObservableConsumerFactory {
    ...
    public <K, V> ObservableKafkaConsumer<RecordsBatch<K, V>> newConsumer(String topic, ErrorHandler errorHandler) {
        return new BatchedObservableKafkaConsumer<>(topic, kafkaProperties.load(jksFileService, topic), errorHandler);
    }
}
