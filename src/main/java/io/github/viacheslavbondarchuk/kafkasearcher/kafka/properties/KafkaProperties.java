...
public record KafkaProperties(String bootstrapServers, Duration pollTimeout, int batchSize, String securityProtocol, SSLProperties sslProperties) {
    public static final String SECURITY_INTER_BROKER_PROTOCOL = "security.inter.broker.protocol";
    public static final String SSL_PROTOCOL = "SSL";
    public static final String OFFER_SEARCHER = "offer-searcher";
    ...
    public Map<String, Object> load(JKSFileService jksFileService, String topic) {
        ...
        properties.put(MAX_POLL_RECORDS_CONFIG, batchSize);
        properties.put(FETCH_MAX_WAIT_MS_CONFIG, 100);
        properties.put(GROUP_ID_CONFIG, CommonUtils.createGroupId(OFFER_SEARCHER, topic));
